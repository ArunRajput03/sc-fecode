      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
          ...
          <div className="grid gap-6 lg:gap-8 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
            <div className="p-4 text-primary-700 bg-primary-100 rounded-lg dark:bg-primary-900 dark:text-primary-300">
            ...
            <div className="p-4 text-teal-600 bg-teal-100 rounded-lg dark:bg-teal-900 dark:text-teal-300">
              <h2 className="text-3xl font-extrabold leading-tight">600+</h2>
              <span className="text-teal-500 dark:text-teal-400">
                Cryptocurrencies listed
              </span>
            </div>
            <div className="p-4 text-indigo-700 bg-indigo-100 rounded-lg dark:bg-indigo-900 dark:text-indigo-300">
              <h2 className="text-3xl font-extrabold leading-tight">
                34 million
              </h2>
            ...
            <div className="p-4 text-purple-700 bg-purple-100 rounded-lg dark:bg-purple-900 dark:text-purple-300">
              <h2 className="text-3xl font-extrabold leading-tight">
                90 million
              </h2>
            ...
            <div className="p-4 text-green-600 bg-green-100 rounded-lg dark:text-green-300 dark:bg-green-900">
